...
Stay tuned as we continue to monitor the exciting advancements in this field.',
    ...
    'a1b2c3d4-e5f6-7890-1234-567890abcdef', -- Example author_id (ensure this user exists or use NULL)
    'Material Science',
...
-- You can add more INSERT statements here following the same pattern.
